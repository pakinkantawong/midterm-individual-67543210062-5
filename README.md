...
✅ นักเรียนจะเข้าใจ:
1. โครงสร้าง Layered Architecture และประโยชน์
2. วิธีแยก code ให้ชัดเจน ตามหน้าที่
3. การ design API ที่ RESTful
4. Error handling ที่ centralised
5. ทำไมการ refactor จึงสำคัญ